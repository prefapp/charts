...
| volume.efs_id                    | For add the `volumeHandle`                                                                                                                                                                               | {}      | {}                               |
| volume.labels                    | Common labels for pvc                                                                                                                                                                               | {}      | {}                               |
| volume.mount                      | mount point for `mountPath`.                                                                                                                                                                                   | string  | ""                               |
| volume.otherCommands                      | For add other commands of permissions.                                                                                                                                                                                   | string  | ""                               |
| volume.storageClass                      | Define the storage class: `[ ebs-disk, gcp-disk, azure-disk, azure-file-share,nfs...]`                                                                                                                                                                                   | string  | ""                               |
| volume.storageSize                      | Define the storage capacity in                                                                                                                                                                                   | string  | ""                               |
